...
- c_q01_direct budget 512: cause=distractor_failure, F1=0.000, missing=['student_access', 'annex_alias'], distractors=['c04'], selected=['c03', 'c04', 'c13', 'c15', 'c16', 'c21', 'c24']
...
- q13_three_hop budget 256: cause=distractor_failure, F1=0.808, missing=['log'], distractors=['p22'], selected=['p09', 'p10', 'p12', 'p22', 'p24', 'p36', 'p37', 'p38']
